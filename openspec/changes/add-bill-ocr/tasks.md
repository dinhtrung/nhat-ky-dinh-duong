...
- [ ] 6.4 Commit **targeted add**, push `main`; verify asset live sau khi Vercel deploy (grep marker trong `app.js` + `vendor/tesseract/worker.min.js` trả 200) — phần verify live chờ deploy Vercel của `add-meal-tracker-mvp`
